...
if os.path.exists(f"../results/lgbm_num_iterations.csv"):
    logger = open(f"../results/lgbm_num_iterations.csv", "a")
else:
    logger = open(f"../results/lgbm_num_iterations.csv", "w")
...
def objective(trial):
    sampled_params = {"num_iterations": trial.suggest_int("num_iterations", 250, 1500)}
...
###########################################################################################
search_space = {
    'num_iterations': [250, 500, 750, 1000, 1250, 1500],
    }
